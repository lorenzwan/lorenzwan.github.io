...
def reloadImported(packageNames: list[str] | str):
    """
    Reload imported modules under a specific package(s).
    
    :param packageNames: name of the package
    """
    if type(packageNames) == str:
...
Pages like [RegEX Cheat Sheet & Quick Reference](https://quickref.me/regex.html) and [RegExr: Learn, Build, & Test RegEx](https://regexr.com) help a lot!
